...
import (
	...
	"github.com/m1981/temporal-go-agent-sdk/pkg/llm/gemini"
	"github.com/m1981/temporal-go-agent-sdk/pkg/llm/openai"
...
// This is not [github.com/m1981/temporal-go-agent-sdk/pkg/agent.MCPConfig] (per-server agent transport + filter).
