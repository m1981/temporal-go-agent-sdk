...
// [github.com/m1981/temporal-go-agent-sdk/pkg/mcp.MCPStdio] or [github.com/m1981/temporal-go-agent-sdk/pkg/mcp.MCPStreamableHTTP]
// (see [github.com/m1981/temporal-go-agent-sdk/pkg/agent.WithMCPConfig]); this package performs the wire-up.
package client
...
// transportCfg is the same value you set on [github.com/m1981/temporal-go-agent-sdk/pkg/agent.MCPConfig].Transport (e.g. [github.com/m1981/temporal-go-agent-sdk/pkg/mcp.MCPStdio], [github.com/m1981/temporal-go-agent-sdk/pkg/mcp.MCPStreamableHTTP]).
