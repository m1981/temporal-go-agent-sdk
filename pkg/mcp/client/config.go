...
import (
	...
	"github.com/m1981/temporal-go-agent-sdk/pkg/mcp"
)

// ClientConfig holds optional settings for [NewClient].
// Logger and LogLevel mirror pkg/llm.LLMConfig; Timeout, RetryAttempts, and ToolFilter align with [github.com/m1981/temporal-go-agent-sdk/pkg/agent.MCPConfig] (same field semantics as [github.com/m1981/temporal-go-agent-sdk/pkg/agent.MCPConfig.ToolFilter] / [mcp.MCPToolFilter]).
...
// WithToolFilter sets allow/block lists (same semantics as [github.com/m1981/temporal-go-agent-sdk/pkg/agent.MCPConfig.ToolFilter]).
