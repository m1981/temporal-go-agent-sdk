...
//go:generate mockgen -destination=./mocks/mock_observability.go -package=mocks github.com/m1981/temporal-go-agent-sdk/pkg/interfaces Tracer,OTelTracer,Metrics,Span,Logs
