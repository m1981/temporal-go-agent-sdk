...
//go:generate mockgen -destination=./mocks/mock_mcp.go -package=mocks github.com/m1981/temporal-go-agent-sdk/pkg/interfaces MCPClient
...
type MCPClient interface {
	// Name identifies this connection for logging and tool prefixes (e.g. [github.com/m1981/temporal-go-agent-sdk/pkg/agent.MCPServers] key or [github.com/m1981/temporal-go-agent-sdk/pkg/mcp/client.NewClient] first argument).
	Name() string
