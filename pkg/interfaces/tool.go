...
//go:generate mockgen -destination=./mocks/mock_tool.go -package=mocks github.com/m1981/temporal-go-agent-sdk/pkg/interfaces Tool,ToolApproval,ToolAuthorizer
