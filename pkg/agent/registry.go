...
//go:generate mockgen -destination=./mocks/mock_registry.go -package=mocks github.com/m1981/temporal-go-agent-sdk/pkg/agent ToolRegistry,MCPRegistry,A2ARegistry,SubAgentRegistry
