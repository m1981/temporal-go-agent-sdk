...
import (
	...
	"github.com/m1981/temporal-go-agent-sdk/internal/runtime"
	"github.com/m1981/temporal-go-agent-sdk/internal/runtime/temporal"
	"github.com/m1981/temporal-go-agent-sdk/internal/types"
	"github.com/m1981/temporal-go-agent-sdk/pkg/conversation"
...
// Set [MCPConfig.Transport] and [MCPConfig.ToolFilter] using types from [github.com/m1981/temporal-go-agent-sdk/pkg/mcp] (MCPStdio, MCPStreamableHTTP, MCPToolFilter).
...
type A2AConfig struct {
	...
	// Use [github.com/m1981/temporal-go-agent-sdk/pkg/a2a.A2ASkillFilter] for the same type in application code.
...
// WithMaxTokens sets the cumulative token budget for the agent run.
// When exceeded, the agent stops and returns what it has. 0 means no limit.
...
// Use [mcpclient.NewClient] with [mcpclient.WithToolFilter] for the same allow/block filtering as [MCPConfig.ToolFilter] ([mcpclient.BuildConfig] validates the filter; [github.com/m1981/temporal-go-agent-sdk/pkg/mcp.MCPToolFilter.Apply] runs in [mcpclient.Client.ListTools]).
// Applies to Agent and AgentWorker.
