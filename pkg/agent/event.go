...
import "github.com/m1981/temporal-go-agent-sdk/internal/events"

//go:generate mockgen -destination=./mocks/mock_event.go -package=mocks github.com/m1981/temporal-go-agent-sdk/pkg/agent AgentEvent
