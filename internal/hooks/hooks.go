...
// Register hooks via [github.com/m1981/temporal-go-agent-sdk/pkg/agent.WithHooks]; types are re-exported
...
// [github.com/m1981/temporal-go-agent-sdk/pkg/agent.WithHooks].
...
type RunMeta struct {
	...
	// HooksGroup is the [github.com/m1981/temporal-go-agent-sdk/pkg/agent.WithHooks] group name for the
